...
export const startChangePatient = async (
  machineId: string,
): Promise<string> => {
...
export const changePatient = async (
  ...
  const response = await api.put(`/machines/change-patient/${machineId}`, {
    patient: patientId,
    lockId: lockId,
  });
  return response.data;
...
export const updateMachine = async (
  ...
  const response = await api.put(`/machines/${machineId}`, {
    name: name,
    location: location,
  });
  return response.data;
...
export const exitChangePatient = async (machineId: string, lockId: string) => {
  const response = await api.put(`/machines/change-patient/exit/${machineId}`, {
    lockId: lockId,
  });
  return response.data;
};
